...
const PROJECT_LIST = [
  {
    ...
    title: '똑똑 365',
    description: [
      '홈 클리닝 애플리케이션. 정리수납과 가사 서비스를 원하는 시간에 예약하여 이용할 수 있는 서비스로 유저 전용 앱과 파트너 전용 앱으로 구성.',
      '현재 애플 앱스토어 및 구글 플레이스토어에 출시되어 다수의 유저들이 사용 중.',
      ...
      'React Native을 사용하여 크로스 플랫폼 앱을 개발하고, shadcn/ui를 사용하여 공통 컴포넌트를 사용할 수 있도록 구현.'
    ],
